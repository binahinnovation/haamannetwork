        ...
        try {
          ...
          if (data.user && data.user.id) {
            ...
            const user = {
              ...
              opayAccountNumber: profileData.opay_account_number || null,
              opayAccountName: profileData.opay_account_name || null,
              palmpayAccountNumber: profileData.palmpay_account_number || null,
              palmpayAccountName: profileData.palmpay_account_name || null,
              paymentpointCustomerId: profileData.paymentpoint_customer_id || null,
              bvn: profileData.bvn,
              hasPin: false,
            };
